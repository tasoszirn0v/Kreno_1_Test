...
class Chat : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            .addValueEventListener(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (snapshot1 in snapshot.children) {
                        ...
                        val encryptedCiphertext: ByteArray = Base64.getDecoder().decode(message!!.message)
                        ...
                        val decryptedCiphertext = decrypt(aesKey, encryptedCiphertext)
                        val decryptedMessage = String(decryptedCiphertext, Charsets.UTF_8)
        ...
        binding!!.sentButton.setOnClickListener(View.OnClickListener {
            ...
            val encryptedCiphertext = encrypt(aesKey, plaintext)

            val encryptedCiphertextString = String(Base64.getEncoder().encode(encryptedCiphertext))
            val date = Date()
            val message = Message(encryptedCiphertextString, senderUid, date.time)
    ...
    //ENCRYPT & DECRYPT FOR HYBRID SCHEME
